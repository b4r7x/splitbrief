...
| 20 | **Hook system** — user-extensible workflow lifecycle commands (unrelated to React hooks) fire at workflow events (`pre_task`, `post_commit`, etc.); trust prompt prevents RCE. | [HOOKS-CONFIG.md](./HOOKS-CONFIG.md) |
