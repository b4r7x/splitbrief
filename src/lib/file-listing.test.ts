...
describe('listProjectFiles', () => {
  ...
  it('lists regular files from a non-git project', () => {
  ...
  it('excludes sensitive files from the filesystem fallback', () => {
  ...
  it('uses git listing when available so ignored files are omitted', () => {
