...
describe('resolveKeyOwner', () => {
  it.each<MatrixCase>([
    ...
    {
      name: 'plan editor task list',
      input: 'j',
      key: {},
      inputMode: 'review',
      focus: 'plan-editor-task-list',
      expected: 'plan-editor',
      action: 'j',
    },
    {
      name: 'plan editor task list uppercase R',
      input: 'R',
      key: {},
      inputMode: 'review',
      focus: 'plan-editor-task-list',
    ...
    {
      name: 'plan editor task list uppercase E',
      input: 'E',
      key: {},
      inputMode: 'review',
      focus: 'plan-editor-task-list',
    ...
    {
      name: 'plan editor task list uppercase Y',
      input: 'Y',
      key: {},
      inputMode: 'review',
      focus: 'plan-editor-task-list',
    ...
    {
      name: 'plan editor task list lowercase r',
      input: 'r',
      key: {},
      inputMode: 'review',
      focus: 'plan-editor-task-list',
    ...
    {
      name: 'plan editor task list lowercase e',
      input: 'e',
      key: {},
      inputMode: 'review',
      focus: 'plan-editor-task-list',
    ...
    {
      name: 'plan editor task list lowercase y',
      input: 'y',
      key: {},
      inputMode: 'review',
      focus: 'plan-editor-task-list',
    ...
    {
      name: 'plan editor section list',
      input: 'e',
      key: {},
      inputMode: 'review',
      focus: 'plan-editor-section-list',
      expected: 'plan-editor',
      action: 'e',
    },
    {
      name: 'plan editor section list uppercase Y',
      input: 'Y',
      key: {},
      inputMode: 'review',
      focus: 'plan-editor-section-list',
    ...
    {
      name: 'plan editor section list lowercase y',
      input: 'y',
      key: {},
      inputMode: 'review',
      focus: 'plan-editor-section-list',
    ...
    {
      name: 'plan editor editing text chord',
      input: 'a',
      key: { ctrl: true },
      inputMode: 'review',
      focus: 'plan-editor-editing-section',
      expected: 'text-editing',
      action: 'move-line-start',
    },
    {
      name: 'overlay escape',
      input: '',
