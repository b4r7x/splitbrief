...
describe('ModelsDevModelSchema flat-rate pricing', () => {
  it('keeps the base input/output rate and drops tiered long-context fields', () => {
    ...
    expect(parsed.cost).not.toHaveProperty('tiers');
    expect(parsed.cost).not.toHaveProperty('context_over_200k');
  });
