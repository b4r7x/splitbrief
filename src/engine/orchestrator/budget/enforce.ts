...
import { RecoveryOperationEnvelopeSchema } from '../../../core/schemas/brief-recovery.js';
...
export type ProviderDependentReservationInput = Readonly<{
  ...
  envelope: RecoveryOperationEnvelope;
}>;
...
export function reserveProviderDependentRecoveryCall(
  ...
  const parsedEnvelope = RecoveryOperationEnvelopeSchema.safeParse(input.envelope);
