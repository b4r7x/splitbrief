...
/**
 * Minimal glob matching for inBounds patterns.
 * Supports exact match, prefix globs (src/foo/** or src/foo/), and extension wildcards (*.ts).
 * Does not use micromatch (not installed). For complex glob patterns, upgrade to micromatch.
 */
