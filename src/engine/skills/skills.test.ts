...
const { parseFrontmatter, discoverSkills, loadSkillContent, buildSkillsSection } = await import('./skills.js');
...
describe('discoverSkills', () => {
  ...
  it('returns empty array when no skills exist', () => {
    expect(discoverSkills('claude-code', TMP)).toEqual([]);
  });
