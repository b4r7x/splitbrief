...
describe('getErrorHint', () => {
  it.each([
    ...
    ['API error 401 from custom-endpoint: Unauthorized', 'Invalid API key', 'API_KEY'],
    [
    ...
    ['API error 429 from custom-endpoint: Too Many Requests', 'Rate limited by provider', 'Wait'],
