...
/**
 * These tests exercise the real subprocess seam. `claude-runner.ts` hardcodes
 ...
 * each test. The shim emits real stream-json lines so the runner's parse +
 * state-aggregation path is observable end-to-end.
 */
