...
Before changing a subsystem, follow the matching doc linked from the **Documentation map** in `CLAUDE.md`.

**Do not run `git add`, `git stage`, or `git commit`.** The user reviews and commits manually.
